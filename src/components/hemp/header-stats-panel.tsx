...
/**
 * HeaderStatsPanel - Standardized header statistics cards for HEMP pages
 *
 * Features:
 * - White background cards with blue left border
        ...
        {cards.map((card, idx) => (
          <div key={idx} style={{
            ...
            >
              ...
              {/* Optional Sub-text */}
              {card.sub && <p style={{ fontSize: 9.5, color: `rgba(14, 68, 124, 0.55)`, marginTop: 4, margin: 0 }}>{card.sub}</p>}
            </div>
          </div>
        ))}
      </div>
